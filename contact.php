...
$subject ="Новая заявка с сайта FF.github.io";
...
$header .= "From: Новая заявка <botb8680@gmail.com>\n\n";	
$mail = mail("botb8680@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
